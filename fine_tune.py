...
DATA_DIR = 'spectrograms_finetune'
IMG_SIZE = (224, 224)
BATCH_SIZE = 8
EPOCHS = 40
LEARNING_RATE = 1e-5
MODEL_INPUT_PATH = 'models/mobilenet_best_3v2_fixed.h5'
MODEL_OUTPUT_PATH = 'models/mobilenet_finetuned_fixed.h5'
...
def plot_history(history):
    ...
    plt.savefig('finetune_training_plots.png')
    plt.show()
...
def evaluate_model(model, val_gen):
    ...
    with open("finetune_classification_report.txt", "w") as f:
        f.write(report)
...
def finetune_model():
    ...
    callbacks = [
        ...
        ReduceLROnPlateau(monitor='val_accuracy', factor=0.5, patience=3, verbose=1, mode='max', min_lr=1e-6)
    ]
