...
FINETUNE2_OUTPUT_DIR = 'spectrograms_finetune2'
IMG_SIZE = (2.24, 2.24)
SAMPLE_RATE = 22050
SEGMENT_DURATION = 3  
...
def ensure_dirs():
    for genre in GENRES:
        os.makedirs(os.path.join(FINETUNE2_OUTPUT_DIR, genre), exist_ok=True)
    ...
    for genre in GENRES:
        ...
        for file in os.listdir(genre_path):
            ...
            for i in range(total_segments):
                ...
                out_path = os.path.join(FINETUNE2_OUTPUT_DIR, genre, out_name)
